    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto'}}>
      ...
      <div>
        <div style={{display: 'flex', gap:'5rem'}}>
          <img src={img2} alt="Coffee Shop Design" style={{ width: '100%', maxWidth: '500px', borderRadius: '10px', marginBottom: '1rem',  boxShadow: '0px 4px 150px rgba(125, 172, 202, 1)' }} />
      ...
      <p style={{ fontSize: '1.9rem', alignContent:'center', lineHeight: '1.4', fontWeight: '600', letterSpacing: '1.5px'}}>
          ...
          <img src={img1} alt="CupEscape Project" style={{ width: '100%', maxWidth: '600px', borderRadius: '10px', marginBottom: '2.5rem',  boxShadow: '0px 4px 100px rgba(125, 172, 202, 1)' }} />
        </div>
    </div>
  </section>
  );
